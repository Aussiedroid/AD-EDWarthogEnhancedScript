-----------------------------------------------------------
AUSSIEDROID'S ENHANCED ED-BAT MULTI-LAUNCHER + BACKUP v0.1:
-----------------------------------------------------------
...
1) "Launch EDBat Basic App Suite.bat" = Will open the essential apps only including EDLauncher, TM Target GUI & Script, TrackIR, VA & EDMC (NO BINDS BACKUP).

2) "Launch EDBat Full App Suite Only.bat" = Will open ALL supported apps (NO BINDS BACKUP).

3) "Launch EDBat Full App Suite + Backup.bat" = Will open ALL supported apps PLUS Create a Backup of your Bindings Folder before starting EDLauncher.
